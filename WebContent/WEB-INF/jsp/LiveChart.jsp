							...
							<div class="dropdown-menu" aria-labelledby="message">
								...
								<a class="dropdown-item media bg-flat-color-1" href="#"> <span
									class="photo media-left"><img alt="avatar"
										src="resources/images/avatar/1.jpg"></span> <span
									...
									class="photo media-left"><img alt="avatar"
										src="resources/images/avatar/2.jpg"></span> <span
									class="message media-body"> <span
									...
									class="photo media-left"><img alt="avatar"
										src="resources/images/avatar/3.jpg"></span> <span
									class="message media-body"> <span
									...
									class="photo media-left"><img alt="avatar"
										src="resources/images/avatar/4.jpg"></span> <span
									class="message media-body"> <span
